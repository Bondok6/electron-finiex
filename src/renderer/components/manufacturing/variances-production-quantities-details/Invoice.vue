      ...
      <el-row :gutter="6" class="width-full">
        ...
        <el-col :xs="24" :sm="8" :md="6" :lg="4">
          <el-form-item :label="$t('item-number')">
            <el-input v-model="main_form.item_number"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row :gutter="6" class="width-full">
        ...
        <el-col :xs="24" :sm="8" :md="6" :lg="4">
          <el-form-item :label="$t('item-name')">
            <el-select v-model="main_form.item_name" :label="$t('all')">
              <el-option :label="$t('1')" :value="2"></el-option>
              <el-option :label="$t('2')" :value="1"></el-option>
            </el-select>
          </el-form-item>
        </el-col>
        <el-col :xs="24" :sm="24" :md="4" :lg="10" class="mt-2">
          <div class="inline-button-container d-flex">
            <div class="spacer"></div>
          </div>
        </el-col>
        <el-col :xs="24" :sm="24" :md="8" :lg="6" class="mt-2">
          <div class="inline-button-container d-flex">
            <div class="spacer"></div>
            <el-button
              class="text-center w-250 btn-cyan-light mt-4"
                ...
                >
                  <el-row :gutter="6" class="width-full">
                    <el-col :xs="24" :sm="24" :md="12" :lg="6">
                      <el-form-item>
                        <label>{{ $t("from-production-number") }}</label>
                        <el-select
                          v-model="sub_form.fromNumber"
                          :label="$t('all')"
                        >
                          <el-option :label="$t('1')" :value="2"></el-option>
                          <el-option :label="$t('2')" :value="1"></el-option>
                    ...
                    <el-col :xs="24" :sm="24" :md="12" :lg="6">
                      <el-form-item>
                        <label>{{ $t("to-production-number") }}</label>
                        <el-select
                          v-model="sub_form.toNumber"
                          :label="$t('all')"
                        >
                          <el-option :label="$t('1')" :value="2"></el-option>
                          <el-option :label="$t('2')" :value="1"></el-option>
                    ...
                    <el-col :xs="24" :sm="24" :md="12" :lg="6">
                      <el-form-item>
                        ...
                        <el-select
                          v-model="sub_form.production_status"
                          :label="$t('all')"
                        >
                          <el-option :label="$t('1')" :value="2"></el-option>
                          <el-option :label="$t('2')" :value="1"></el-option>
