      ...
      <el-row :gutter="6" class="width-full">
        <el-col :xs="24" :sm="10" :md="6" :lg="4">
          <el-form-item :label="$t('item-number')">
            <el-input v-model="main_form.number" />
          </el-form-item>
        </el-col>
      </el-row>
      <el-row :gutter="6" class="width-full">
        <el-col :xs="24" :sm="10" :md="6" :lg="4">
          <el-form-item :label="$t('item-name')">
            <el-select v-model="main_form.name" :label="$t('all')">
              <el-option :label="$t('1')" :value="2"></el-option>
              <el-option :label="$t('2')" :value="1"></el-option>
            </el-select>
          </el-form-item>
        </el-col>
        <el-col :xs="24" :sm="24" :md="18" :lg="20" class="mt-2">
                ...
                <el-row :gutter="6" class="width-full">
                  ...
                  <el-col :xs="24" :sm="24" :md="12" :lg="6">
                    <el-form-item>
                      ...
                      <el-select v-model="sub_form.category" :label="$t('all')">
                        <el-option :label="$t('1')" :value="2"></el-option>
                        <el-option :label="$t('2')" :value="1"></el-option>
                      </el-select>
                    </el-form-item>
