<template>
  <el-container class="container ma-4 mt-0 mb-0 invoice-table">
    ...
    >
      ...
      <el-table-column
        align="center"
        prop="perishable_quantity"
        :label="$t('spoil-amount')"
      />
      <el-table-column
        align="center"
        prop="perishable_cost"
        :label="$t('the-cost-of-destruction')"
      />
      <template #append>
        <el-table
          :data="totalAmount"
  ...
  data: function () {
    return {
      tableData: [
        {
          id: "1",
          deliver_number: "881273",
          deliver_date: "2014-02-08",
          production_order_number: "320",
          customer_name: "ايهاب توفيق",
          operation_number: "211",
          perishable_quantity: "22",
          perishable_cost: "444",
        },
        {
          id: "2",
