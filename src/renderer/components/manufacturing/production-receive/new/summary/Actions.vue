<template>
  <div
    ...
    "
  >
    <NuxtLink :to="localePath('/manufacturing/production-orders-plan')">
      <el-button size="mini" class="mb-1 btn-blue">{{
        $t("save-f5")
      }}</el-button>
    </NuxtLink>
    <NuxtLink :to="localePath('/manufacturing/report-production-receive')">
    ...
    <NuxtLink :to="localePath('/manufacturing/production-receive')">
