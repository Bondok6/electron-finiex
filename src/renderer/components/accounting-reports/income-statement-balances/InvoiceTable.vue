...
export default {
  ...
  computed: {
    ...
    ...mapState({
      tableData: state => {
        if (state.Accounting.Reports.incomeStatementBalances.records?.length) {
          return state.Accounting.Reports.incomeStatementBalances.records;
        } else {
          return [];
        }
      },
      tableInfo: function(state) {
        return state.Accounting.Reports.incomeStatementBalances.recordsInfo.map(
          item => {
