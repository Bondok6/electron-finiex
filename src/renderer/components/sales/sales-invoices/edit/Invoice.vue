  ...
  <el-container class="container box-shadow ma-4 mb-0 px-2 py-3 pb-0">
    <el-form class="invoice-form width-full" label-position="top" :model="form">
      <el-row :gutter="6" class="width-full">
        <el-col :xs="24" :sm="24" :md="17" :lg="17">
            ...
            <el-col :xs="24" :sm="24" :md="6" :lg="6">
              <el-form-item :label="$t('payment-method')">
                <el-select v-model="form.payment_method">
                  <el-option :label="$t('normal-cash')" :value="1"></el-option>
          ...
          <el-row :gutter="6" class="width-full">
            ...
            <el-col :xs="24" :sm="24" :md="6" :lg="6">
              <el-form-item
                :label="$t('currency-exchange-price')"
        ...
        <el-col :xs="24" :sm="24" :md="7" :lg="7">
          <div class="four-button-invoice">
            <!---- ------------------ suspended-invoices -------------------- -->
            <el-button
              @click="include_suspended_invoices = !include_suspended_invoices"
              :class="[
                include_suspended_invoices ? 'btn-dark-grey' : 'btn-red'
              ]"
            ...
            >
              <div class="add-btn add-btn-grey bordered-bottom">
              ...
              <div
                class="add-btn add-btn-grey bordered-bottom"
                :class="{
                  active: control_invoice_options.show_invoice_profit_checked
                }"
              ...
              <div @click="openAttachFileDialog()" class="add-btn add-btn-grey bordered-bottom">
                {{ $t("attach-a-file") }}
              </div>

              <div
                @click="openSearchInvoiceCategoriesDialog()"
                class="add-btn add-btn-grey"
              >
      ...
      <el-row :gutter="6" class="width-full info">
        ...
        <div
          class="info-card losts"
          v-show="control_invoice_options.show_invoice_profit_checked"
        >
          خسارة 200
        </div>
        <div
          class="info-card losts"
          v-show="control_invoice_options.show_return_invoice_card_checked"
        >
          رقم فاتورة الارتجاع = 1
        </div>
      </el-row>
    </el-form>
    <!-- additional data -->
...
export default {
  ...
  methods: {
    ...
    toggleCurrencyCheckbox() {
      this.additional_info_control.currency_checked 
      = !this.additional_info_control.currency_checked;

      this.$store.commit("sales/salesInvoices/updateShowIntervals", 
                          this.additional_info_control.currency_checked);
    }
  },
