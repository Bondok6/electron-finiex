  ...
  <el-container class="container box-shadow ma-4 mb-0 px-2 py-3 pb-1">
    <el-form class="invoice-form width-full" label-position="top" :model="form">
        ...
        <el-col :xs="24" :sm="24" :md="4" :lg="4">
          <el-form-item :label="$t('invoice-price')"
            ...
            <el-select v-model="form.invoice_price">
              <el-option :label="$t('selling-price')" :value="1"></el-option>
              <el-option :label="$t('purchasing-price')" :value="2"></el-option>
            </el-select>
          </el-form-item>
        </el-col>

        <el-col :xs="24" :sm="24" :md="4" :lg="4">
          <el-form-item :label="$t('offer-end')">
            <el-date-picker
              type="date"
              placeholder="2020-10-15"
      ...
      <el-row :gutter="6" class="width-full">
        ...
        <el-col :xs="24" :sm="24" :md="4" :lg="4">
          <el-form-item :label="$t('client-balance')">
            <el-input v-model="form.client_balance" placeholder="0">
              <template slot="append">
                <div> 0 </div>
              </template>
            </el-input>
