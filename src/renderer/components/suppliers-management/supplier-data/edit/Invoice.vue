            ...
            <table style="width: 100%">
              <tbody>
                ...
                <tr>
                  ...
                  <td class="input-padding">
                    <el-input v-model="form.mailNo" class="placeHolderDialog" 
                    >
                    </el-input>
                  </td>
                </tr>
            ...
            <table style="width: 100%">
              <tbody>
                ...
                <tr>
                  ...
                  <td class="input-padding">
                    <el-input v-model="form.fax" class="placeHolderDialog" 
                    >
                    </el-input>
                  </td>
                </tr>
    ...
    singleRecordDetails: {
      handler({code,
        ...
        this.form = {
          ...
          mobile,
          email,
          zipCodeType: zipCodeType === 0 ? null : zipCodeType,
          providerType: providerType === 0 ? null : providerType,
          phone,
          fax,
          accountNature: accountNature === 0 ? null : accountNature,
        };
      },
      deep : true
    },
