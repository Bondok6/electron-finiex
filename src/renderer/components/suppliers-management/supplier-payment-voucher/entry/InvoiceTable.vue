  ...
  <el-container class="container ma-4 mt-0 mb-0 invoice-table">
    <el-table :data="tableData" style="width: 100%" border stripe max-height="500">
      ...
      <el-table-column align="center" prop="bond_number" :label="$t('bond-number')">
        <template>
        <NuxtLink :to="localePath('/accounting/supplier-payment-bond/edit')">
          <span>1</span>
        </NuxtLink>
        </template>
      </el-table-column>
      <el-table-column align="center" prop="bond_date" :label="$t('bond-date')" />
      <el-table-column align="center" prop="supplier_name" :label="$t('supplier-name')" />
      ...
      <el-table-column align="center" prop="bond_type" :label="$t('bond-status')" />
    </el-table>
      <accountingtree />
  </el-container>
</template>
      ...
      tableData: [
        {
          ...
          item_number: '1',
          bond_number : '1',
          bond_date : '01 / 04 / 2021',
          supplier_name: 'احمد',
          invoice_number : '5362863',
          amount_paid : '3052562',
          bond_type : 'مرحل',
