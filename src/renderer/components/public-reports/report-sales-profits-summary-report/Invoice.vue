      ...
      <el-row :gutter="6" class="width-full">
        ...
        <el-col :xs="24" :sm="24" :md="9">
          <div class="four-button-invoice ">
            ...
            <el-select
              v-model="form.type"
              class="color-blue text-center placeHolderColor selector-mod class_a"
              :placeholder="$t('order-by')"
            >
              <el-option :label="$t('highest-profit-value')" :value="1"></el-option>
              <el-option :label="$t('lowest-profit-value')" :value="2"></el-option>
              <el-option :label="$t('highest-sales-quantity')" :value="3"></el-option>
              <el-option :label="$t('lowest-sales-quantity')" :value="1"></el-option>
              <el-option :label="$t('highest-sales-value')" :value="2"></el-option>
              <el-option :label="$t('lowest-sales-value')" :value="3"></el-option>
            </el-select>
            ...
            <!---- extras---->
            <el-button
              class="text-center btn-cyan-light width-full mt-1 additionalChoices class_c"
