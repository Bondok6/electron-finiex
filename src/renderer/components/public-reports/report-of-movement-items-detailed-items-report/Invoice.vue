            ...
            <el-col :xs="24" :sm="24" :md="8">
              <el-form-item :label="$t('item-number')">
                <el-select v-model="form.input" :placeholder="$t('all')">
                    ...
                    <el-option :label="$t('all')" :value="1" @click.native="summaryTableNone()"></el-option>
                
                    <el-option label="1" :value="2" @click.native="summaryTableDisplay()"></el-option>
                </el-select>
              </el-form-item>
            </el-col>
          </el-row>
        ...
        <el-col :xs="24" :sm="24" :md="9">
          <div class="four-button-invoice">
            ...
            >
              ...
              <el-option
                :label="$t('imported-quantity')"
                :value="4"
              ></el-option>
              <el-option
                :label="$t('exported-quantity')"
                :value="5"
              ></el-option>
            </el-select>
            ...
            <el-button
              @click="
                form.include_sales_invoices_associated_with_external_representative =
                  !form.include_sales_invoices_associated_with_external_representative
              "
              :class="[
                form.include_sales_invoices_associated_with_external_representative
            ...
            >
              ...
              >
                {{
                  $t(
                    "include-sales-invoices-associated-with-external-representative"
                  )
                }}
              </span>
              <span v-else>
                {{
                  $t(
                    "non-include-sales-invoices-associated-with-external-representative"
                  )
                }}
              </span>
            </el-button>
...
export default {
  ...
  methods: {
    summaryTableNone() {
      this.$store.commit("detaileditemsreport/updateTableState", false);
    },

    summaryTableDisplay() {
      this.$store.commit("detaileditemsreport/updateTableState", true);
    },
  },
};
</script>
