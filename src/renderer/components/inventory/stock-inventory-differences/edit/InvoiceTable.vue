<template>
  <el-container
    class="container ma-4 mt-0 mb-0 invoice-table min-height-250 editable-table"
  >
    <el-table
      :data="tableData"
      style="width: 100%"
      ...
      max-height="250"
    >
      <el-table-column align="center" prop="id" :label="$t('id')" width="50">
      ...
      <el-table-column
        align="center"
        prop="difference_quantity"
        :label="$t('difference-quantity')"
      >
        <template slot-scope="scope">
          <el-input
            size="small"
            style="text-align: center"
            v-model="scope.row.difference_quantity"
          ></el-input>
        </template>
      </el-table-column>
      <el-table-column
