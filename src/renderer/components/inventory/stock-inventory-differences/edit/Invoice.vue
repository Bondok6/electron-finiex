      ...
      <el-row :gutter="6" class="width-full">
        ...
        <el-col :xs="24" :sm="24" :md="9" :lg="12" class="mt-40">
          <div class="inline-button-container d-flex">
            ...
            <el-select
              v-model="form.type"
              class="color-blue text-center placeHolderColor mobile-width-full selectButton w-300"
            ...
            >
              <el-option
                ...
                class="selectButton"
              >
                <el-button class="width-full"  @click="openListManualDialog(true)">{{
                  $t("listing-items-by-manual-inventory")
                }}</el-button></el-option
              >
              <el-option
                ...
                class="selectButton"
              >
                <el-button class="width-full" @click="openListMachineDialog(true)">{{
