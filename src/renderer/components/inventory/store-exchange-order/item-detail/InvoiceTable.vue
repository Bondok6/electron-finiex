      ...
      <template #append>
        ...
        >
          ...
          <el-table-column
            ...
            :label="$t('quantity')"
          />
          <el-table-column align="center" prop="cost" :label="$t('cost')" />
          <el-table-column align="center" prop="total" :label="$t('total')" />
          <el-table-column
            align="center"
            prop="delete_icon"
    ...
    <el-dialog title=" " :visible.sync="dialog" width="70%">
      <span>
        <el-container class="d-block box-shadow mb-0 px-2 py-2">
          ...
          <el-table
            :data="itemDetailTable"
            class="width-full addItemTable mb-4"
            stripe
            border
            max-height="250"
          >
  ...
  data: function () {
    return {
      ...
      tableData: [
        {
          id: 1,
          item_name: "Rs25a - كوع زاوية 225*250 كلاس ",
          item_category: "||||",
          item_unit: "حبة",
