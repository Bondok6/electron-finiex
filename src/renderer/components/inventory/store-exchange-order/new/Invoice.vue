      ...
      <el-row :gutter="6" class="width-full">
        <el-col :span="24">
          <el-row :gutter="6">
            <el-col :xs="24" :sm="6" :md="4" :lg="4">
              <el-form-item :label="$t('exchange-order-number')">
            ...
            <el-col :xs="24" :sm="6" :md="4" :lg="4">
              <el-form-item :label="$t('exchange-order-date')">
                <el-date-picker
                  type="date"
            ...
            <el-col
              ...
              :md="4"
              :lg="4"
              :class="[delegate_exchange ? 'd-block' : 'display-none']"
            >
            ...
            <el-col
              ...
              :md="4"
              :lg="4"
              :class="[operation_exchange ? 'd-block' : 'display-none']"
            >
        ...
        <el-col :span="24">
          <el-row :gutter="6">
            ...
            <el-col :xs="24" :sm="6" :md="4" :lg="4">
              <el-form-item :label="$t('exchange-order-rate')">
                <el-select v-model.number="form.priceID">
                      <el-option
              ...
              <div class="inline-button-container d-flex">
                ...
                <el-select
                  ...
                  class="
                    ...
                    w-250
                  "
                  :placeholder="$t('exchange-type')"
                >
                  <el-option
                    :value="1"
                    class="selectButton"
                    :label="$t('delegate-exchange')"
                  >
                  ...
                  <el-option
                    :value="2"
                    class="selectButton"
                    :label="$t('operation-exchange')"
                  >
                    <el-button @click="operation" class="width-full">
                      {{ $t("operation-exchange") }}
                    </el-button>
                  </el-option>
                </el-select>
              </div>
...
export default {
  ...
  data: function () {
    return {
      loading: false,
      delegate_exchange: true,
      operation_exchange: false,
      form: {
        invoiceId: null,
        payType: 0,
        salesManCode: null,
        ...
        priceID: null,
        costCenterID: 0,
        dateGr: "2022-10-25T09:30:14.500Z",
      },
    };
  },
  ...
  computed :{ 
    ...mapState({
      ...
      PriceColumn: state => state.inventory.storeExchangeOrder.PriceColumn,
  ...
  methods: {
    ...
    delegate() {
      this.delegate_exchange = true;
      this.operation_exchange = false;
      this.form.payType = 0 ;
      this.form.accId = 0 ;
    },

    operation() {
      this.operation_exchange = true;
      this.delegate_exchange = false;
      this.form.payType = 1 ;
  ...
  created() {
    this.$store.dispatch("inventory/storeExchangeOrder/fetchMaxCode").then(res => {
