          ...
          <el-row :gutter="6">
            ...
            <el-col :xs="24" :sm="6" :md="6" :lg="3">
              <el-form-item :label="$t('from-number')">
                <el-input v-model="form.numFrom" placeholder="3"></el-input>
              </el-form-item>
            </el-col>
          ...
          <el-row :gutter="6">
            <el-col :xs="24" :sm="6" :md="6" :lg="5">
              <el-form-item :label="$t('to-date')">
                <el-date-picker type="date" v-model="form.to"></el-date-picker>
              </el-form-item>
            </el-col>
...
export default {
  ...
  methods: {
    ...mapMutations({
      setRecordDetails: "Accounting/vatStatementReport/setRecordDetails"
    })
  },
  computed: {
    ...mapState({
