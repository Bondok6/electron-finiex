    ...
    >
      ...
      <el-table-column align="center" prop="data" :label="$t('statement')">
        <template slot-scope="scope">
          ...
          <el-input
            size="small"
            v-model="scope.row.voucherDescriptions"
                  ...
                  <el-form class="" label-position="top">
                    <el-form-item class="form-item-with-right-label width-full">
                      <el-input
                        ...
                        @input="
                          scope.row.voucherDescriptions = dialogValue;
                          dialogValue =
...
export default {
  ...
  methods: {
    ...mapMutations({
      setRecordDetails:
        "Accounting/debtorNotice/earnedDiscount/setRecordDetails",
    }),
    newRow() {
    ...
    openDialog(scope) {
      ...
      this.dialogValue = scope.row.voucherDescriptions;
      setTimeout((x) => {
        this.$nextTick(() =>
