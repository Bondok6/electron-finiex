...
export const actions = {
  suggestCode() {
    return this.$axios("general/items-categories/max-code");
  },
  ...
  create(_, payload) {
    ...
    return this.$axios.post("general/items-categories", record);
  },
  update(_, payload) {
    let record = new FormData();
    for (let key in payload) {
    ...
    return this.$axios.put("general/items-categories", record);
  },
  delete(_, { id }) {
    return this.$axios.delete(`general/items-categories/${id}`);
  },
  fetchSingleRecord(_, { id }) {
    return this.$axios.get(`general/items-categories/${id}`);
  }
};
