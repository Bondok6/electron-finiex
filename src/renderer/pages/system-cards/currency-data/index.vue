...
<script>
import Invoice from "~/components/system-cards/currency-data/entry/Invoice.vue";
import InvoiceTable from "~/components/system-cards/currency-data/entry/InvoiceTable.vue";
import InvoiceSummary from "~/components/system-cards/currency-data/entry/summary/Summary.vue";
...
export default {
  ...
  computed: {
    ...mapState({
      records: state => state.systemCards.currencyData.records,
      paginationConfig: state => state.systemCards.currencyData.paginationConfig,
