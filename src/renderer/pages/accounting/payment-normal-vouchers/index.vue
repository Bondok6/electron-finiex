...
import Invoice from "~/components/accounting/payment-normal-vouchers/entry/Invoice";
import InvoiceTable from "~/components/accounting/payment-normal-vouchers/entry/InvoiceTable";
import InvoiceSummary from "~/components/accounting/payment-normal-vouchers/entry/summary/Summary";
export default {
